// =======================================================================
// FILE: /components/components_admin/modalDelateInfografis.tsx
...
export default function ModalDelateInfografis() {
  ...
  return (
    <>
      <Button onPress={onOpen} isIconOnly color="danger" variant="light" aria-label="Delete">
          ...
          {(onClose) => (
            <>
              <ModalHeader className="flex gap-2 text-red-600 font-bold text-xl items-center">
                <FontAwesomeIcon icon={faTrash} /> Delete Infographic
              </ModalHeader>
              <ModalBody>
