// =======================================================================
// FILE: /components/components_admin/contentBooks.tsx
          ...
          {books.map((book, index) => (
            <div key={index} className="flex flex-col sm:flex-row bg-gray-50 rounded-lg p-4 gap-4 items-start sm:items-center border">
              ...
              <div className="text-start flex-1">
                <NextLink href="/admin/catalog-management/books/book" className="text-sm font-semibold mb-2 hover:underline text-gray-800">
                  {book.title}
                </NextLink>
