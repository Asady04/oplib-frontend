// =======================================================================
// FILE: /components/contentJournals.tsx
// =======================================================================
...
// Helper Components for contentJournals.tsx
const BookResultCard_Journals = ({ title, author, publisher, classification, category, keywords, imageUrl, href }: {
    title: string;
    author: string;
    publisher: string;
...
export const ContentJournals = () => (
    <div className="space-y-6 my-8">
        {Array(8).fill(0).map((_, index) => (
            <BookResultCard_Journals 
                key={index}
                {...journalData}
                imageUrl="/assets/image/cover buku journal.svg"
                href="/landing/catalog/journals/journal"
            />
        ))}
    </div>
);